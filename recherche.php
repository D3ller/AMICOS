...
<main>
    ...
    <div class="form-recherche">
        ...
        <button aria-label="Renverser les localisations" id='reverse' onclick="reverse()"><svg style="margin-top:5px" width="26" height="21" viewBox="0 0 26 21" fill="none" xmlns="http://www.w3.org/2000/svg">
