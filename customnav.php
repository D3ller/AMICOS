...
if($_SERVER['PHP_SELF'] == "/profil.php"){
    ...
    echo '<a aria-label="Icon" href="./index.php"><div id="backarrow"></div></a>';
    echo '<p>Profil</p>';
    echo '<a aria-label="Icon" href="./parametre.php"><div id="threepoint"></div></a>';
    ...
    echo '<a aria-label="Icon" href="./parametre.php"><div id="backarrow"></div></a>';
    echo '<p>CGU</p>';
    ...
    echo '<a aria-label="Icon" href="/profil.php"><div id="backarrow"></div></a>';
    echo '<p>';
 ...
 elseif($_SERVER['PHP_SELF'] == '/pdc.php') {
    ...
    echo '<a aria-label="Icon" href="javascript:history.back()"><div id="backarrow"></div></a>';
    echo '<p>Match</p>';
    echo '<div style="opacity: 0; visibility: hidden" id="threepoint"></div>';
    ...
    echo '<nav class="cstm" style="background: #FE1269; margin-bottom: 0; border-bottom-left-radius: 50px; border-bottom-right-radius: 50px;">';
    echo '<a aria-label="Icon" style="opacity: 0; visibility: hidden"><div id="backarrow"></div></a>';
    ...
    echo '<nav class="cstm" style="background: #ffab02; margin-bottom: 0; border-bottom-left-radius: 50px; border-bottom-right-radius: 50px;">';
    echo '<a aria-label="Icon" href="/"><div id="backarrow"></div></a>';
    echo '<p style="color:white; text-align:center;">Mot de passe</p>';
    echo '<div style="opacity: 0; visibility: hidden" id="threepoint"></div>';
    ...
    echo '<nav class="cstm" style="background: #8ea7e3; margin-bottom: 0; border-bottom-left-radius: 50px; border-bottom-right-radius: 50px;">';
    echo '<a aria-label="Icon" href="/profil"><div id="backarrow"></div></a>';
    echo '<p style="color: white">';
